...
describe('PokemonService', () => {
  ...
  it('should fetch Pokemon details', () => {
    const dummyPokemon = {
      "id": 1, "name": "bulbasaur", "height": 7, "weight": 69, "base_experience": 64, "types": [
        {
          "slot": 1,
          "type": {
            "name": "grass",
    ...
    service.getPokemonDetail(1).subscribe(pokemon => {
      expect(pokemon).toEqual(dummyPokemon as Pokemon);
    });

    const req = httpMock.expectOne(`${environment.apiUrl}/pokemon/1`);
